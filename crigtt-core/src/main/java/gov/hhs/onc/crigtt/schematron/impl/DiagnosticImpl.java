...
public class DiagnosticImpl implements Diagnostic
{
     ...
     * 
     */
    public DiagnosticImpl(final List<Serializable> content, final String id, final String icon, final String see, final String fpi, final Map<QName, String> otherAttributes) {
