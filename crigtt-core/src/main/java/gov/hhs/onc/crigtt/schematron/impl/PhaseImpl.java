...
public class PhaseImpl implements Phase
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "active", namespace = "http://purl.oclc.org/dsdl/schematron", type = ActiveImpl.class, required = false),
     ...
     * 
     */
    public PhaseImpl(final List<Object> content, final String id, final String icon, final String see, final String fpi, final Map<QName, String> otherAttributes) {
