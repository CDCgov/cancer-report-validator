...
public class ReportImpl implements Report
{
     ...
     * 
     */
    public ReportImpl(final List<Serializable> content, final String test, final String flag, final String id, final List<Object> diagnostics, final String role, final String subject, final String icon, final String see, final String fpi, final Map<QName, String> otherAttributes) {
