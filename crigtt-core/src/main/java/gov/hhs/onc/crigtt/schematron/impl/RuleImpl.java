...
public class RuleImpl implements Rule
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "assert", namespace = "http://purl.oclc.org/dsdl/schematron", type = AssertionImpl.class, required = false),
        @XmlElementRef(name = "report", namespace = "http://purl.oclc.org/dsdl/schematron", type = ReportImpl.class, required = false),
        @XmlElementRef(name = "let", namespace = "http://purl.oclc.org/dsdl/schematron", type = LetImpl.class, required = false),
        @XmlElementRef(name = "extends", namespace = "http://purl.oclc.org/dsdl/schematron", type = ExtensionImpl.class, required = false),
     ...
     * 
     */
    public RuleImpl(final List<Object> content, final String flag, final Boolean _abstract, final String id, final String context, final String role, final String subject, final String icon, final String see, final String fpi, final Map<QName, String> otherAttributes) {
