...
public class SuccessfulReportImpl implements SuccessfulReport
{
     ...
     * 
     */
    public SuccessfulReportImpl(final List<DiagnosticReference> diagnosticReference, final String text, final String id, final String location, final String test, final String role, final String flag) {
