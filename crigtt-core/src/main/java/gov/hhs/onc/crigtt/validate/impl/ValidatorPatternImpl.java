...
@JsonTypeName("validatorPattern")
public class ValidatorPatternImpl implements ValidatorPattern
{
     ...
     * 
     */
    public ValidatorPatternImpl(final String id, final String name) {
        this.id = id;
        this.name = name;
    }
