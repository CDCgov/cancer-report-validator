...
@JsonTypeName("validatorSchema")
public class ValidatorSchemaImpl implements ValidatorSchema
{
     ...
     * 
     */
    public ValidatorSchemaImpl(final String id, final String name) {
        this.id = id;
        this.name = name;
    }
